...
#ifndef MYNEWAPP_SWIFT_H
#define MYNEWAPP_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="MyNewApp",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC8MyNewApp11AppDelegate")
...
SWIFT_CLASS("_TtC8MyNewApp13SceneDelegate")
...
SWIFT_CLASS("_TtC8MyNewApp14ViewController")
